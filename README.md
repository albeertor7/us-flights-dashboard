...
The heavy per-flight dataset (`bts_2023_clean.parquet`, ~61MB) isn't tracked directly in git — [download it from Releases](https://github.com/albeertor7/us-flights-dashboard/releases/download/data-v1/bts_2023_clean.parquet) or regenerate it locally by running the pipeline.
